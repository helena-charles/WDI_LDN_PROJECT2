module.exports = [{
  danceClass: 'Tap Dance',
  studio: ['Dance Attic'],
  content: 'Tap dance is a form of dance characterized by using the sounds of tap shoes striking the floor as a form of percussion. The sound is made by shoes that have a metal "tap" on the heel and toe. Two major variations on tap dance exist: rhythm (jazz) tap and Broadway tap.',
  image: 'https://www.artnewsportal.com/images_news/2017/1226296_135350_216191_logo_tap-dance-madrid_claim.jpg',
  category: 'Tap'
},{
  danceClass: 'Jamaican Dancehall',
  studio: ['Husky Studios'],
  content: 'The popularity of dancehall has spawned dance moves that help to make parties and stage performances more energetic. Dancing is an integral part of bass culture genres. As people felt the music in the crowded dancehall venues, they would do a variety of dances. Eventually, dancehall artists started to create songs that either invented new dances or formalized some moves done by dancehall goers. Many dance moves seen in hip hop videos are actually variations of dancehall dances.',
  image: 'https://media.timeout.com/images/103864219/630/472/image.jpg',
  category: 'World'
},{
  danceClass: 'Afrobeats',
  studio: ['Studio B'],
  content: 'Afrobeats dance classes draw influence from a variety of modern and traditional dance and music styles from the African diaspora including Nigeria, Ghana, Angola and much more. Popular afrobeats dances include the azonto and alingo.',
  image: 'http://sanantonio.carpediem.cd/data/afisha/o/bd/e6/bde6a10455.jpg',
  category: 'World'
},{
  danceClass: 'Ballet',
  studio: ['Danceworks'],
